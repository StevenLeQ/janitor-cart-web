...
import { CurrencyDollarIcon, UserPlusIcon, BuildingOfficeIcon, UsersIcon } from '@heroicons/react/24/outline'
  ...
  return (
    <div className="w-full mb-5">
      ...
      <div className="mt-8 mx-10 grid gap-x-4 gap-y-7 grid-cols-12">
        <DashboardItem title="$12,489" subtitle="Annual Sales" percent={0.43} icon={<CurrencyDollarIcon className="w-10 h-10" />}/>
        <DashboardItem title="34" subtitle="New Customers" percent={4.35} icon={<UserPlusIcon className="w-10 h-10" />} />
        <DashboardItem
          title="582"
        ...
        />
        <DashboardItem title="389" subtitle="Total users" percent={0.95} icon={<UsersIcon className="w-10 h-10" />} />
